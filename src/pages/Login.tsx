          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <div className="input-group">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Link to="/forgot-password" style={{ fontSize: '12px', color: '#c8102e', fontWeight: 600, textDecoration: 'none' }}>Forgot password?</Link>
              </div>
              <div className="input-wrapper">
                ...
                <button
                  ...
                  style={{ position: 'absolute', right: '12px', background: 'none', border: 'none', color: '#64748b', cursor: 'pointer', fontSize: '12px', fontWeight: 600 }}
                >
